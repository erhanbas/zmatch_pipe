...
% test_image = DataManager.load_single_tiff(test_tile_fp);
...
% descriptor_folder = '/data/Vessel/ML_stitching/2018-08-15/stage_2_descriptor_output';
% point_match_folder = '/data/Vessel/ML_stitching/2018-08-15/stage_3_point_match_output';
