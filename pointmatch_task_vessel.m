...
parfor idx=from:to
    ...
    pointmatch_vessel(tile1,tile2,acqusitionfolder1,acqusitionfolder2,outfold,pixshift,ch,maxnumofdesc,exitcode)
end
delete(gcp('nocreate'))
...
compiledfunc = '/groups/mousebrainmicro/home/jix/Documents/GitHub/compiledfunctions/pointmatch_task_vessel/pointmatch_task_vessel';
