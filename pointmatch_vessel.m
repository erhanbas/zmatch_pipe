...
%         descriptor_valid_bbox_mmxx(5) = descriptor_valid_bbox_mmxx(5) - 5;
...
%         test_image_1 = tile_image_1(overlap_bbox_1_mmxx(1):overlap_bbox_1_mmxx(4), overlap_bbox_1_mmxx(2):overlap_bbox_1_mmxx(5), overlap_bbox_1_mmxx(3):overlap_bbox_1_mmxx(6));
%         test_image_2 = tile_image_2(overlap_bbox_2_mmxx(1):overlap_bbox_2_mmxx(4), overlap_bbox_2_mmxx(2):overlap_bbox_2_mmxx(5), overlap_bbox_2_mmxx(3):overlap_bbox_2_mmxx(6));
...
%         matched_image_1 = tile_image_1(:, :, test_sec_in_2 + pixshift_z);
%         figure;
%         subplot(1,3,1);
%         plot(scan_score_xy)
%         moved_image = imtranslate(test_image_2, pixshift_xy);        
%         subplot(1,3,2);
...
%% If both the descriptor contains boundary large vessels 
    ...
    if descriptor_1.record.exist_blv && descriptor_2.record.exist_blv
        desc1_edge = descriptor_1.blv_sub;
        desc2_edge = descriptor_2.blv_sub;
